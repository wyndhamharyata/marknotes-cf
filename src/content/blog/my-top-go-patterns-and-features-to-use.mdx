...
Random string? UUID? hell, autoincrement number? _Please don't be an autoincrement number_.
...
Hit me up through [email](mailto:business@mwyndham.dev), LinkedIn ([linkedin.com/in/mwyndham](https://www.linkedin.com/in/mwyndham)), or my Twitter / X account (@muhwyndam).
