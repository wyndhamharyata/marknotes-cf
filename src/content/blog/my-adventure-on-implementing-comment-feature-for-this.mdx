...
<BlogImage src="https://resource.mwyndham.dev/0-Screenshot_2025-06-11_at_19.29.08-20250611122928.webp" alt="Thread" />
...
<figure class="my-6">
  <img src="https://media.disquscdn.com/upvoted-comment-disqus.png" alt="New Connections via Disqus. But Only If You Want To." class="rounded-lg shadow-md mx-auto" loading="lazy" />
</figure>
...
<BlogImage src="https://resource.mwyndham.dev/0-Comment_Flow(1)-20250611125739.webp" alt="Comment Flow" />
...
<BlogImage src="https://resource.mwyndham.dev/0-Screenshot_2025-06-11_at_20.09.37-20250611130956.webp" alt="Sample of the Comment Feature" />
...
<BlogImage src="https://resource.mwyndham.dev/0-Screenshot_2025-06-11_at_20.57.58-20250611135808.webp" alt="curses example" />
...
<BlogImage src="https://resource.mwyndham.dev/0-Moderation_Type-20250611142601.webp" alt="moderation type" />
...
- **Dangerous** means anything that immediately harmful. Personal attack, hate speech, spam, anything goes. This category of comment will be hidden from other user but the trace of it will be visible with text *Comment hidden by Auto Moderation* in place instead.

<BlogImage src="https://resource.mwyndham.dev/0-Screenshot_2025-06-11_at_21.36.49-20250611143700.webp" alt="auto moderation example" />
...
If you're curious how I do it, just go over to the repository for this blog, it's public on GitHub 😉: [github.com/muhwyndhamhp/marknotes/blob/main/internal/llm/client.go](https://github.com/muhwyndhamhp/marknotes/blob/main/internal/llm/client.go)
...
<BlogImage src="https://resource.mwyndham.dev/0-Screenshot_2025-06-11_at_22.48.18-20250611154946.webp" alt="v0 moderation" />
...
<BlogImage src="https://resource.mwyndham.dev/0-Screenshot_2025-06-11_at_22.50.53-20250611155212.webp" alt="comment moderation" />

<BlogImage src="https://resource.mwyndham.dev/0-Screenshot_2025-06-11_at_22.50.59-20250611155232.webp" alt="comment moderation 2" />
...
<BlogImage src="https://resource.mwyndham.dev/0-Screenshot_2025-06-11_at_22.57.25-20250611155740.webp" alt="reply context" />
...
<BlogImage src="https://resource.mwyndham.dev/0-Screenshot_2025-06-11_at_22.59.55-20250611160008.webp" alt="detail dialog" />

If I were to click *"Mark as Safe"* it will change the moderation status to OK. And if I were to click delete, then it'll show the deleted by admin message you see few section ago!
